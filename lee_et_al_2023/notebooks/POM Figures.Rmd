...
author: "Brian K. Lee†, Emily J. Mayhew†, Benjamin Sanchez-Lengeling, Jennifer N. Wei, Wesley Qian, Kelsie Little, Matthew Andres, Britney B. Nguyen, Theresa Moloy, Jane Parker, Richard C. Gerkin, Joel D. Mainland, Alex Wiltschko"
date: "`r Sys.Date()`"
output:
  html_document:
    code_folding: hide
...
S1 <- read.csv("Resubmission/Data S1.csv") %>%
...
#save figure output
ggsave("Resubmission/Final Figures/Figure 2 panels/MulticomparisonOTTbarplot.svg", height = 3, width = 3.2)
...
### save figure
ggsave("Resubmission/Final Figures/Figure 3 panels/Disagg_Label_resub.svg", height = 7, width = 3.5)
...
ggsave("Resubmission/Final Figures/Figure 3 panels/Disagg_ChemClass_resub.svg", height = 2.2, width = 3.8)
...
ggsave("Resubmission/Final Figures/Figure 3 panels/GCO_waffle_resub.svg", height = 2, width = 5.5)
```
...
DREAM <- read.table("DREAMTrainSet.txt", fill = T, header = T, sep = "\t", comment.char = "")
